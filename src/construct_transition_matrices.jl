using Statistics
export construct_states, construct_holding_times, transition_rate_matrix
export construct_count_matrix, perron_frobenius_matrix
...
function construct_count_matrix(markov_chain, number_of_states)
