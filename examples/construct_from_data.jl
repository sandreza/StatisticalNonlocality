...
function perron_frobenius_m(markov_chain, number_of_states)
...
perron_frobenius_m(markov_chain) = perron_frobenius_m(markov_chain, maximum(markov_chain))
